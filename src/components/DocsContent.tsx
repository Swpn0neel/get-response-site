...
const architectureData = [
  ...
  { 
    ...
    desc: "Direct integration with Gemini 2.5 and Stack Exchange.", 
    ...
    <div className="max-w-4xl mx-auto py-16 px-8 space-y-24 scroll-smooth">
      ...
      <section id="features" className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { title: "Gemini Integration", desc: "Uses Google’s latest 2.5 Flash model for ultra-fast, conversational AI responses." },
            ...
            <div key={i} className="p-6 rounded-2xl bg-surface-container-lowest border hover:border-primary/30 transition-all group">
      ...
      <section id="architecture" className="space-y-12">
        ...
        <div className="grid grid-cols-1 gap-4">
          {architectureData.map((item, i) => (
            <div key={i} className="flex items-start gap-6 p-6 rounded-2xl border bg-surface-container-lowest relative overflow-hidden group">
              ...
              <div className="space-y-2 flex-1">
                ...
                <div className="flex gap-2 pt-2">
                  {item.files.map((file) => (
                    <code key={file} className="text-[10px] font-technical px-2 py-0.5 rounded bg-zinc-100 text-zinc-600 border border-zinc-200">
                      {file}
                    </code>
                  ))}
                </div>
        ...
        <div className="space-y-16">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl border bg-surface-container-lowest space-y-3">
                <div className="flex items-center gap-2 text-primary font-bold text-sm">
                  <FileText size={16} /> PDF Parsing
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Analyze technical papers, documentations, or logs using the <code className="text-[10px] px-1 bg-zinc-100 rounded">pdf-parse-fork</code>. 
            ...
            <div className="overflow-hidden rounded-2xl border bg-surface-container-lowest overflow-x-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl border bg-white space-y-4">
                <div className="flex items-center gap-2 text-primary">
                  <Terminal size={18} />
                  <span className="text-xs font-bold uppercase tracking-widest text-primary">Chat Mode</span>
                </div>
                <p className="text-sm text-zinc-500">Maintains persistent session context for back-and-forth reasoning.</p>
                <code className="block p-3 rounded-lg bg-zinc-50 text-xs text-primary font-technical border">
                  $ npx get-response -c
                </code>
              </div>
              <div className="p-6 rounded-2xl border bg-white space-y-4">
                ...
                <p className="text-sm text-zinc-500">In-terminal search and summarize for Stack Overflow.</p>
                <code className="block p-3 rounded-lg bg-zinc-50 text-xs text-[#F48024] font-technical border">
          ...
          <div className="space-y-6" id="automation">
            ...
            <div className="p-6 rounded-2xl border bg-surface-container-lowest space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                required. With the <code className="text-xs px-1 py-0.5 bg-zinc-100 rounded">--auto</code> flag (experimental), 
                the tool can even assist in executing these tasks safely after your confirmation.
              </p>
              <div className="space-y-3">
                <div className="text-[10px] uppercase font-bold text-zinc-400 tracking-wider">Example Command</div>
                <code className="block p-4 rounded-xl bg-zinc-950 text-zinc-300 text-xs font-technical border border-white/5">
          ...
          <div className="space-y-6" id="diagrams">
            ...
            <div className="p-6 rounded-2xl border bg-surface-container-lowest space-y-4">
              ...
              <code className="block p-4 rounded-xl bg-zinc-50 text-xs text-primary font-technical border">
      ...
      <section id="tech-stack" className="space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={tech} className="p-4 rounded-xl border bg-zinc-50/50 flex items-center justify-center text-xs font-bold uppercase tracking-tight text-center">
              {tech}
            </div>
          ))}
        </div>
